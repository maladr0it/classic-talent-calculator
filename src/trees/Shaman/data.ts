    ...
    talents: {
      ...
      "Ancestral Healing": {
        ...
        description: talentText`Increases your target's armor value by ${[
          ...
          10,
          15,
        ]}% for 20 sec after getting a critical effect from one of your healing spells.`,
      },
      "Totemic Focus": {
        name: "Totemic Focus",
        pos: "b3",
      ...
      "Healing Way": {
        ...
        description: talentText`Your Healing Wave spells have ${[
          ...
          80,
          100,
        ]}% chance to increase the effect of subsequent Healing Wave spells on that target by 3% for 15 sec. This effect will stack up to 5 times.`,
      },
      "Nature's Swiftness": {
