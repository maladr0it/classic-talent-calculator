  ...
  Arms: {
    ...
    talents: {
      ...
      "Sweeping Strikes": {
        ...
        maxRank: 1,
        reqPoints: 20,
        description: talentText`Your next 10 melee attacks strike an additional nearby opponent. Lasts 20 sec.`,
      },
      "Mace Specialization": {
  ...
  Fury: {
    ...
    talents: {
      ...
      "Improved Slam": {
        ...
        description: talentText`Decreases the casting time of your Slam ability by ${[
          ...
          1,
          1.5,
        ]} sec${["", "", " but Slam now has a 10 sec cooldown"]}.`,
      },
      "Death Wish": {
        name: "Death Wish",
        pos: "e2",
	...
	prereq: "Enrage",
      ...
      "Bloodthirst": {
        ...
        prereq: "Death Wish",
        arrows: [{ dir: "down", from: "e2", to: "g2" }],
        description: talentText`Instantly attack the target causing damage equal to 50% of your attack power. In addition, your successful melee attacks have a 25% chance to drain 50 life. This effect lasts 3 charges or 15 sec.`,
      },
  ...
  Protection: {
	...
	prereq: "Improved Revenge",
      ...
      "Vitality": {
        ...
        maxRank: 5,
        reqPoints: 25,
        description: talentText`Increases healing taken by 3% and your total health by ${[
          2,
          4,
          6,
          8,
