  ...
  Retribution: {
    ...
    talents: {
      ...
      "Improved Seal of the Crusader": {
        ...
        maxRank: 3,
        reqPoints: 0,
        description: talentText`Increases the holy damage and melee attack power bonus of your Seal of the Crusader and the Holy damage increase of your Judgement of the Crusader by ${[
          5,
          10,
          15,
        ]}%.`,
      ...
      "Survived to Avenge": {
        name: "Survived to Avenge",
        pos: "c1",
        icon: icons["survived_avenge"],
        maxRank: 3,
        reqPoints: 5,
        prereq: "Deflection",
