  ...
  Demonology: {
    ...
    talents: {
      ...
      "Fel Domination": {
        ...
        description: talentText`Your next Imp, Voidwalker, Succubus, or Felhunter Summon spell has its casting time reduced by 5.5 sec and its mana cost reduced by 55%. In addition, increases the duration of your next Enslave Demon up to 15 minutes.`,
      },
      "Demonic Onslaught": {
